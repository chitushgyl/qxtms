...
//        $user_id = $input['user_id'];
        ...
        $body = '';//商品描述，可空
        $timeExpress = '15m';
        $notify_url = $notify_url."/api/pay/notify_url";//异步通知地址
...
//        QRcode::png($url);
    ...
    public function actionAli_regchange()
    {
        ...
        $timeExpress = '15m';
        $notify_url = $notify_url."/api/pay/alipay_notify";//异步通知地址
//        $return_url = "https://user.56cold.com";//同步跳转
        //构造参数
        $payRequestBuilder = new \AlipayTradePagePayContentBuilder;
        $payRequestBuilder->setBody($body);
...
//        $refund = $res['alipay_trade_refund_response'];
    ...
    public function actionPay_member()
    {
        ...
        $timeExpress = '15m';
        $notify_url = $notify_url."/api/pay/member_notify";//异步通知地址
//        $return_url = "https://user.56cold.com";//同步跳转
        //构造参数
        $payRequestBuilder = new \AlipayTradePagePayContentBuilder;
        $payRequestBuilder->setBody($body);
...
//         $this->check_group_auth($order->group_id,$user);
    ...
    public function actionAlipay_take()
    {
        ...
        $body = '';//商品描述，可空
        $timeExpress = '15m';
        $notify_url = $notify_url."/api/pay/take_notify";//异步通知地址
//        $return_url = "https://user.56cold.com";//同步跳转
        //构造参数
        $payRequestBuilder = new \AlipayTradePagePayContentBuilder;
        $payRequestBuilder->setBody($body);
...
//            }
    ...
    public function actionBulk_alipay()
    {
        ...
        $body = '';//商品描述，可空
        $timeExpress = '15m';
        $notify_url = $notify_url."/api/pay/bulk_notify";//异步通知地址
//        $return_url = "https://user.56cold.com";//同步跳转
        //构造参数
        $payRequestBuilder = new \AlipayTradePagePayContentBuilder;
        $payRequestBuilder->setBody($body);
