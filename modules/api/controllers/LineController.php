...
class LineController extends CommonController
{
    ...
    public function actionAdd(){
        ...
        $group = AppGroup::findOne($group_id);
        $time3 = date('mdHis',time());
        $c1 = $this->getfirstchar($group['group_name']);
        $c2 = $this->getfirstchar($group['group_name'],1,1);
        $c3 = $this->getfirstchar($startcity);
        $c4 = $this->getfirstchar($endcity);
        $model->shiftnumber = $c1.$c2.$c3.$c4.$time3.'5';
        $model->startcity = $startcity;
        $model->endcity = $endcity;
