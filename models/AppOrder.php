...
class AppOrder extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['company_id', 'create_user_id', 'group_id','cargo_user', 'deal_company', 'order_type', 'cartype', 'picktype', 'sendtype', 'where', 'carriage_status', 'order_status', 'pay_status', 'line_status', 'oil_number', 'order_own', 'unusual', 'unusual_id', 'paytype', 'carriage_id', 'split', 'main_order', 'split_id', 'line_id','deal_user'], 'integer'],
