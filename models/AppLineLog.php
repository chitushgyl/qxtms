...
class AppLineLog extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['begin_store', 'end_store', 'weight_price', 'center_store'], 'string'],
            [['line_price', 'pickprice', 'sendprice', 'all_weight', 'all_volume', 'freepick'], 'number'],
            [['group_id', 'picktype', 'sendtype', 'create_user_id', 'line_state', 'carriage_id', 'copy', 'carriage', 'copy_id'], 'integer'],
            [['startcity', 'endcity', 'startarea', 'endarea', 'centercity'], 'string', 'max' => 10],
            [['trunking', 'time_week'], 'string', 'max' => 30],
