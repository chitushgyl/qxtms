...
/**
 * This is the model class for table "app_common_store".
 *
 * @property string $id
 ...
 */
class AppCommonStore extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['contact', 'create_user'], 'string', 'max' => 30],
            [['phone'], 'string', 'max' => 11],
