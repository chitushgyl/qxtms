...
?>
    ...
    <script type="text/html" id="options">
        <div class="layui-btn-group">
            <?php if(can('admin.car.car_view')){?>
                <a class="layui-btn layui-btn-primary layui-btn-sm " lay-event="car_view">详情</a>
            <?php } ?>
        </div>
    </script>
        ...
        layui.use(['layer','table','form'],function () {
            ...
            var dataTable = table.render({
                ...
                ,cols: [[ //表头
                    ...
                    ,{field: 'carnumber', title: '车牌号', align:'center',width:200}
                    ,{field: 'control', title: '温控', align:'center',width:180}
                    ,{field: 'driver_name', title: '姓名/电话', align:'center',width:200,toolbar:'#mobile'}
                    ,{field: 'board_time', title: '初始上牌日期', align:'center',width:200}
                    ,{field: 'check_time', title: '验车日期', align:'center',width:200}
